...
#define __PYX_HAVE__elf2jelf__jelf_loader
#define __PYX_HAVE_API__elf2jelf__jelf_loader
#include "string.h"
#include "stdio.h"
#include "stdint.h"
...
/* Module declarations from 'elf2jelf.jelf_loader' */
#define __Pyx_MODULE_NAME "elf2jelf.jelf_loader"
int __pyx_module_is_main_elf2jelf__jelf_loader = 0;

/* Implementation of 'elf2jelf.jelf_loader' */
...
/* Python wrapper */
static PyObject *__pyx_pw_8elf2jelf_11jelf_loader_1jelf_loader_hash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
...
static PyObject *__pyx_pw_8elf2jelf_11jelf_loader_1jelf_loader_hash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_name_to_sign)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("jelf_loader_hash", 1, 2, 2, 1); __PYX_ERR(0, 39, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "jelf_loader_hash") < 0)) __PYX_ERR(0, 39, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("jelf_loader_hash", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 39, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("elf2jelf.jelf_loader.jelf_loader_hash", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static PyObject *__pyx_pf_8elf2jelf_11jelf_loader_jelf_loader_hash(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_fn, PyObject *__pyx_v_name_to_sign) {
  ...
  __Pyx_RefNannySetupContext("jelf_loader_hash", 0);

  /* "elf2jelf/jelf_loader.pyx":40
 * 
 * def jelf_loader_hash(fn: bytes, name_to_sign: bytes):
 *     if sodium_init() == -1:             # <<<<<<<<<<<<<<
 *         return;
 * 
 */
  __pyx_t_1 = ((sodium_init() == -1L) != 0);
  if (__pyx_t_1) {

    /* "elf2jelf/jelf_loader.pyx":41
 * def jelf_loader_hash(fn: bytes, name_to_sign: bytes):
 *     if sodium_init() == -1:
 *         return;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_AsString(__pyx_v_fn); if (unlikely((!__pyx_t_2) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_AsString(__pyx_v_name_to_sign); if (unlikely((!__pyx_t_3) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L1_error)
  jelfLoaderInit((&__pyx_v_ctx), __pyx_v_fd, __pyx_t_3, (&jelf_loader_env));
 ...
 */
  ...
  /* "elf2jelf/jelf_loader.pyx":52
 *     jelfLoaderRelocate(ctx);
 *     jelfLoaderProfilerPrint();
 *     return jelfLoaderGetHash(ctx)[:64];             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __Pyx_PyBytes_FromStringAndSize(((const char*)jelfLoaderGetHash(__pyx_v_ctx)) + 0, 64 - 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
 ...
 *         return;
 */
  __pyx_tuple_ = PyTuple_Pack(4, __pyx_n_s_fn, __pyx_n_s_name_to_sign, __pyx_n_s_ctx, __pyx_n_s_fd); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_bpugh_esp_nano_app_jolt_wa, __pyx_n_s_jelf_loader_hash, 39, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_elf2jelf__jelf_loader) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "elf2jelf.jelf_loader")) {
      if (unlikely(PyDict_SetItemString(modules, "elf2jelf.jelf_loader", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         return;
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8elf2jelf_11jelf_loader_1jelf_loader_hash, NULL, __pyx_n_s_elf2jelf_jelf_loader); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_jelf_loader_hash, __pyx_t_1) < 0) __PYX_ERR(0, 39, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init elf2jelf.jelf_loader", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init elf2jelf.jelf_loader");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
