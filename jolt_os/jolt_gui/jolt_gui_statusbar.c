...
static void statusbar_update( lv_task_t *task ) {
...

    {
        ...
        if( wifi_level == -1 ); /* Display Nothing */
        else if( wifi_level == 0 ) strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_WIFI_DISCONN, sizeof(statusbar_symbols));
        else if (wifi_level <= 55) strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_WIFI_3, sizeof(statusbar_symbols));
        else if (wifi_level <= 75) strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_WIFI_2, sizeof(statusbar_symbols));
        else                       strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_WIFI_1, sizeof(statusbar_symbols));
    }
...

    {
        ...
        if( battery_level > 100 )     strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_BATTERY_CHARGING, sizeof(statusbar_symbols));
        else if( battery_level > 70 ) strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_BATTERY_3, sizeof(statusbar_symbols));
        else if( battery_level > 45 ) strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_BATTERY_2, sizeof(statusbar_symbols));
        else if( battery_level > 15 ) strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_BATTERY_1, sizeof(statusbar_symbols));
        else                          strlcat(statusbar_symbols, JOLT_GUI_SYMBOL_BATTERY_EMPTY, sizeof(statusbar_symbols));
    }
