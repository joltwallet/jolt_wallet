...
const uint8_t spp_adv_data[23] = {
        /* Max Advertising Payload 31 bytes */
...
const esp_ble_adv_params_t spp_adv_pair_params = {
        .adv_int_min = 0x200, /* Minimum advertising interval for undirected and low duty cycle directed advertising. N
                               * 0.625 mS */
        .adv_int_max       = 0x400,
...
const esp_gatts_attr_db_t spp_gatt_db[SPP_IDX_NB] = {
        ...
        [SPP_IDX_SPP_DATA_NOTIFY_DECL] = {{ESP_GATT_AUTO_RSP},
        ...
        [SPP_IDX_SPP_DATA_NOTIFY_CFG] = {{ESP_GATT_AUTO_RSP},
                                         {.uuid_length = ESP_UUID_LEN_16,
        ...
        [SPP_IDX_SPP_COMMAND_DECL] = {{ESP_GATT_AUTO_RSP},
                                      {.uuid_length = ESP_UUID_LEN_16,
                                       .uuid_p      = (uint8_t *)&character_declaration_uuid,
                                       .perm        = ESP_GATT_PERM_READ,
                                       .max_length  = CHAR_DECLARATION_SIZE,
