...
bool gatts_profile_a_is_connected() { return is_connected; }
...
void IRAM_ATTR gatts_profile_a_event_handler( esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if,
    ...
    switch( event ) {
        ...
        case ESP_GATTS_WRITE_EVT: {
            ...
            if( p_data->write.is_prep == false ) {
                ...
                if( res == SPP_IDX_SPP_COMMAND_VAL ) {
                    ...
                    ESP_LOGI( TAG, "Unknown state machine attribute %d.", res );
                    // TODO:
                }
            }
            else if( ( p_data->write.is_prep == true ) && ( res == SPP_IDX_SPP_COMMAND_VAL ) ) {
        ...
        case ESP_GATTS_CREAT_ATTR_TAB_EVT: {
            ...
            if( param->add_attr_tab.status != ESP_GATT_OK ) {
                ...
                ESP_LOGE( TAG,
                          "Create attribute table abnormally, "
