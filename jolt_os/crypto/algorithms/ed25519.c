                                                 ...
                                                 const uint8_t *private_key, uint16_t private_key_len )
{
    ...
    if( 32 != private_key_len || 32 != public_key_len ) {
                                               ...
                                               const uint8_t *private_key, uint16_t private_key_len )
{
    ...
    if( 32 != private_key_len || 32 != public_key_len || 64 != sig_len ) { return JOLT_CRYPTO_STATUS_PARAM; }
                                                 ...
                                                 size_t msg_len, const uint8_t *public_key, uint16_t public_key_len )
{
    ...
    if( 32 != public_key_len || 64 != sig_len ) { return JOLT_CRYPTO_STATUS_PARAM; }
